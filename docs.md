...
| <a name="input_default_cidr_module"></a> [default\_cidr\_module](#input\_default\_cidr\_module) | https://cloud.yandex.ru/docs/vpc/operations/subnet-create | `list(string)` | <pre>[<br>  "10.0.2.0/24"<br>]</pre> | no |
...
| <a name="input_vpc_name_module"></a> [vpc\_name\_module](#input\_vpc\_name\_module) | VPC network&subnet name | `string` | `"develop_module"` | no |
